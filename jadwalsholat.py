# sholat
# Randioloy
# created 1, September 2019, 2:18 pm
# updated 2, September 2019 2:00 pm
#-*-coding : utf-8-*-
'''
...
def gettime():
      ...
      try:
                        ...
                        print(lg+'\nAstaghfirullah..\nZheyeng lupa ngidupin jaringannya'+x)
                        input(lg+'\nEnterin aja')
                        menu()
...
def banner():
      ...
      ╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝   ╚═╝
                     {lw}Jangan lupa ibadah{lg}
                  {lg}[{x}Spesial Lagi happy;v{lg}]
...
{lg}Nama        : {lw}Jadwalsholat
{lg}Versi       : {lw}1.2 (update: 2, September 2019 2:00 pm)
{lg}Tanggal     : {lw}1, September 2019, 2:18 pm
{lg}Author      : {lw}RandiSr
{lg}Tujuan      : {lw}Mengingatkan kita pada
              waktu sholat
{lg}Terimakasih : {lw}Allah SWT
              Randisahrulromdani dan semua
              umat Muslim seplanet bumi.
{lg}NB          : {lw}Manusia nggak ada yang sempurna,
              sama kaya tool ini.
              Silahkan laporkan kritik atau saran
              ke:  - randisahrulromdani@gmail.com
                   - IG @RanOloy''')
