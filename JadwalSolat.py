...
ctrl + c untuk berhenti''')
            while True:
                  ...
                  if tt == s:
                        ...
                        print (lw+f'                 {lg}WAKTUNYA BANGUN SAHUR ZHEYENG !!!{lw}\n                        untuk wilayah\n               kota {o[7]} dan sekitarnya\n\n{lg}Credit:{x} https://youtu.be/EXjt18hF6UY')
                        print (lg+'_'*63)
...
def exit():
      print(lg+'_'*63)
      print('TERIMAKASIH KAWAN, SEMOGA SEHAT SELALU YA😘'+x)
